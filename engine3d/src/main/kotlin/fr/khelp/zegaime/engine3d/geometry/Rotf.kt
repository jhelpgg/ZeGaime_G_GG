...
import fr.khelp.zegaime.utils.math.EPSILON_FLOAT
...
class Rotf(var w : Float = 1f, var x : Float = 0f, var y : Float = 0f, var z : Float = 0f)
{
    ...
    fun set(source : Vec3f, destination : Vec3f)
    {
        ...
        else
        {
            ...
            {
                arcCosinus /= length
                this.set(axis, Math.acos(arcCosinus.toDouble())
                    .toFloat())
            }
        }
    }
    ...
    fun set(axis : Vec3f, angle : Float)
    {
        ...
        this.w = Math.cos(semiAngle.toDouble())
            .toFloat();
        val sinus = Math.sin(semiAngle.toDouble())
            .toFloat();
     ...
     * Rotation angle
     */
    fun angle() = 2f * Math.acos(this.w.toDouble())
        .toFloat()
