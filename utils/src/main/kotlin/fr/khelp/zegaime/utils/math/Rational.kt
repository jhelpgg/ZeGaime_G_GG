...
import fr.khelp.zegaime.utils.extensions.GCD
import fr.khelp.zegaime.utils.extensions.LCM
import fr.khelp.zegaime.utils.extensions.toRational
                                                                                                   ...
                                                                                                   Number()
{
    companion object
    {
        ...
        fun createRational(numerator : Long, denominator : Long = 1L) : Rational
        {
            ...
            if (denominatorLocal == 0L)
            {
                return Rational.INVALID
            }

            if (numeratorLocal == 0L)
            {
            ...
            return Rational(numeratorLocal / gcd, denominatorLocal / gcd)
        }
        ...
        fun parse(string : String) : Rational
        {
            ...
            try
            {
                return createRational(string.substring(0, index)
                                          .trim()
                                          .toLong(),
    ...
    operator fun plus(number : Number) : Rational
    {
        ...
        return createRational((this.numerator * (lcm / this.denominator)) +
                              (rational.numerator * (lcm / rational.denominator)), lcm)
    }
